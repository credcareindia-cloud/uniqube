...
import { Camera, Save, Mail, Phone, MapPin, Building, Calendar, User, Settings, Activity, Users, Package, TrendingUp } from 'lucide-react'
...
export default function ProfilePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: user?.email || 'demo@uniqube3d.com',
