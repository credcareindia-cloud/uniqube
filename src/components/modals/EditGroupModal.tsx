              ...
              <div className="absolute z-10 mt-2 p-4 bg-[#1A1F2E] border border-[rgba(58,123,213,0.3)] rounded-lg shadow-lg">
                <div className="mb-4">
                  <div
                    ...
                    style={{
                      background: `linear-gradient(to bottom, transparent, black), linear-gradient(to right, white, hsl(${currentHue}, 100%, 50%))`
                    }}
                    onMouseDown={(e) => {
                  ...
                  >
                    <div className="absolute inset-0 rounded-lg" style={{ background: 'linear-gradient(to bottom, transparent, rgba(0,0,0,1))' }} />
                    <div
                ...
                <div className="grid grid-cols-6 gap-2">
                  {PRESET_COLORS.map((presetColor) => (
                    <button
                      ...
                      className={`w-full h-8 rounded-lg border-2 transition-all hover:scale-110 ${color === presetColor ? 'border-white ring-2 ring-slate-700' : 'border-[rgba(58,123,213,0.3)]'
                        }`}
